...
export default function Home() {
 ...
 {/*Feature section*/}
 <div className="mx-auto mb-12 mt-32 max-w-5x1 sm:mt-56">
     <div className='mb-12 px-6 lg:px-8'>
          ...
          <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:p1-0 md:pt-4">
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s that simple. Try out DocChat today -
